...
namespace Sistemas_de_Ventas
{
    public partial class CAJA : Form {
        ...
        private void registrarVenta(){
            ...
            clConsultasFacturas.RegistrarVenta(vent);

            clConsultasFacturas.ActualizarCorte(corteActual.IdCorte, totalV);
            ...
            foreach (DataGridViewRow linea in dataGridView1.Rows){
                ...
                clConsultasFacturas.RegistrarDetalle(codigo, descrp, cantid, 0, 0, total);
            }

            clConsultasFacturas.Registra_Venta_Detalle(vent.IdVenta);
        }
        ...
        private void btAbrirTurno_Click(object sender, EventArgs e) {
            try{
                ...
                ventaNumero = int.Parse(clConsultasFacturas.SiguienteVenta());
        ...
        private void pnl_caja_Paint(object sender, PaintEventArgs e)
        {
